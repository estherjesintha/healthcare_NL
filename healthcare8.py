...
def main():
    ...
    # Try to configure pyproj safely, but never stop execution
    try:
        import pyproj
        ...
        if proj_dir:
            ...
            print("PROJ data dir not found, continuing anyway.")
    except Exception as e:
        print("Warning: could not configure PROJ:", e)
    ...
    def get_db_config():
        ...
        def val(cli, env, prompt, secret=False, default=None):
            if cli:
                return cli
            if os.getenv(env):
        ...
        return {
            "host": val(args.db_host, "DB_HOST", "Host (default: localhost): ", default="localhost"),
            "port": val(args.db_port, "DB_PORT", "Port (default: 5432): ", default="5432"),
            "database": val(args.db_name, "DB_NAME", "Database name: "),
            "user": val(args.db_user, "DB_USER", "Username: "),
            "password": val(args.db_pass, "DB_PASS", "Password: ", secret=True),
        }
